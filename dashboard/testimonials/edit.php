...
if (isset($_REQUEST["editId"])) {
    ...
    $testimonials_query = "SELECT * FROM testimonials where id = $id";
                        ...
                        <form action="store.php?edit_id=<?= $result['id'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <picture class="d-block my-4">
                                    <img id="port_img" src="../../public/testimonials/<?= $result['image'] ?>" alt="portfolio create image" style="width: 100%; height: 150px; object-fit:contain;">
                                </picture>

                                <label for="file" class="form-label">Image</label>
                                <input value="<?= $result['title'] ?>" onchange="document.getElementById('port_img').src= window.URL.createObjectURL(this.files[0])" type="file" name="upload_image" class="form-control mb-2 <?= (isset($_SESSION["image_error"])) ? "is-invalid" : ""; ?> icon_value" id="exampleInputEmail1" aria-describedby="emailHelp">
